...
from common import RESULTS_PATH, get_flu_data, get_population, get_incidence_filenames, get_city_name
...
OUT_PATH = RESULTS_PATH + '/SEIRModel/'
...
def main():
    for city_mark in ['msk']:  # for three cities ,'msk','nsk']
        ...
        invoke(all_files, SEIRSLSQPOptimizer, population,
               city_mark)  # , parallel=False, safe=False)
