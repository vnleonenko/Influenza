...
from common import get_flu_data, RESULTS_PATH, get_population, get_incidence_filenames, remove_background_incidence, \
    get_city_name
...
OUT_PATH = RESULTS_PATH + '/MethodsComparison/%s/'  # city_code
